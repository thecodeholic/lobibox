<div>
    ...
    <div class="container">
        <h2>Show tabbed notifications</h2>
        <button id="notifyTabInfo">Info</button>
        <button id="notifyTabWarning">Warning</button>
        <button id="notifyTabError">Error</button>
        <button id="notifyTabSuccess">Success</button>
        <div>
            <h2>Show notifications</h2>
            <button id="notifyInfo">Info</button>
            <button id="notifyWarning">Warning</button>
            <button id="notifyError">Error</button>
            <button id="notifySuccess">Success</button>
        </div>
    </div>
